...
source /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.flowkit_settings.tcl

source /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.invs_init.tcl
...
source -quiet /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.preserve.tcl

## Reading Innovus Mode attributes file
pqos_eval {rcp::read_taf /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.mode_attributes.taf.gz}


# Mode Setup
################################################################################
source /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.mode
...
################################################################################
      ...
      if { [is_attribute -obj_type port original_name] &&
        ...
        source /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.wnm_attrs.tcl
      }
    

# Reading NDR file
source /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.ndr.tcl

# Reading Instance Attributes file
pqos_eval { rcp::read_taf /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.inst_attributes.taf.gz}

# Reading minimum routing layer data file
################################################################################
pqos_eval {rcp::load_min_layer_file /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../dbs/post_synth/lp_riscv_top.min_layer {} {}}
