...
# Design
################################################################################
read_netlist -top lp_riscv_top /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../export/post_elaboartion/lp_riscv_top.v
read_metric -id current /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../export/post_elaboartion/lp_riscv_top.metrics.json

phys::read_script /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../export/post_elaboartion/lp_riscv_top.g

phys::read_lec_taf /data/project/tsmc65/users/saridav/ws/DVD25/hw7/workspace/../export/post_elaboartion/lp_riscv_top.lec.taf.gz
...
if {$_cell_area_ != "2111394"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 2111394,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
